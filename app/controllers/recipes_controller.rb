class RecipesController < ApplicationController
  ...
  def search
    search_terms = params[:ingredients].split(',').map(&:strip).flat_map { |term| term.split(' ') }
    ...
    # Find recipes with matching ingredients and calculate the percentage of matches
